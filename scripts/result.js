var preclass = sessionStorage.getItem("predictedClass");
var maxProbability = sessionStorage.getItem("maxProbability");
var perElements = document.getElementsByClassName("per");
var typeElements = document.getElementsByClassName("type");

for (var i = 0; i < perElements.length; i++) {
  perElements[i].innerHTML = preclass;
}

for (var i = 0; i < typeElements.length; i++) {
  typeElements[i].innerHTML = maxProbability;
}
